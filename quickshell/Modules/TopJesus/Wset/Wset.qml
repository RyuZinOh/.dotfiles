            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: root.callIpc("setMode", displayRect.modelData)
                    }
                }
            }
        }
        ...
        Row {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: root.callIpc("setTransition", transitionRect.modelData)
                    }
                }
            }
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    enabled: root.currentConfig.mode === "wallpaper"
                    cursorShape: root.currentConfig.mode === "wallpaper" ? Qt.PointingHandCursor : Qt.ArrowCursor
                    onClicked: root.callIpc("setPanning", root.currentConfig.panning ? "false" : "true")
                }
            }
        }
    }
